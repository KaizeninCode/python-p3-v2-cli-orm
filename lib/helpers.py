...
def find_department_by_id():
    # use a trailing underscore to avoid overwriting the in-built id function
...
def create_department():
    ...
    try:
        ...
        print (f'Successfully created {department} department.')
...
def find_employee_by_id():
    ...
    print (employee) if employee else print(f'Employee of id {id_} not found.')
...
def create_employee():
    ...
    try:
        employee = Employee.create(name, department_id, job_title)
...
def list_department_employees():
    ...
    department = Department.find_by_id(id_)
    print (department.employees()) if department else print(f'Department with id {id_} not found.')